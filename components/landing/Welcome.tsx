...
">
        ...
        <motion.div variants={slideUpVariant}  className="basis-[40%] leading-[32px] h-fit">
          ...
          ArsVirtua adalah museum daring pertama di Indonesia yang memiliki seni lukisan legendaris dan terbaik di dunia. <span className="hidden sm:inline">Temukan koleksi lukisan yang beragam dan memiliki kisah yang unik</span></span>
        </motion.div>
      </motion.div>
